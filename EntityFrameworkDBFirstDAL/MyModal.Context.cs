...
namespace EntityFrameworkDBFirstDAL
{
    using System;
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual DbSet<CustomerBackup2021> CustomerBackup2021 { get; set; }
        ...
        public virtual ObjectResult<ListAllCategories_Result> ListAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ListAllCategories_Result>("ListAllCategories");
        }
        ...
        public virtual int SP_AddNewCategory(string categoryName, string categoryExplanation, byte[] image)
        {
            var categoryNameParameter = categoryName != null ?
                new ObjectParameter("categoryName", categoryName) :
                new ObjectParameter("categoryName", typeof(string));
    
            var categoryExplanationParameter = categoryExplanation != null ?
                new ObjectParameter("categoryExplanation", categoryExplanation) :
                new ObjectParameter("categoryExplanation", typeof(string));
    
            var imageParameter = image != null ?
                new ObjectParameter("image", image) :
                new ObjectParameter("image", typeof(byte[]));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_AddNewCategory", categoryNameParameter, categoryExplanationParameter, imageParameter);
        }
        ...
        public virtual ObjectResult<SP_SearchCategory_Result> SP_SearchCategory(string categoryName)
        {
            var categoryNameParameter = categoryName != null ?
                new ObjectParameter("categoryName", categoryName) :
                new ObjectParameter("categoryName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_SearchCategory_Result>("SP_SearchCategory", categoryNameParameter);
        }
    
        public virtual int sp_SumTwoNumbers(Nullable<int> number, Nullable<int> numberSecond, ObjectParameter sum)
        {
            var numberParameter = number.HasValue ?
                new ObjectParameter("number", number) :
                new ObjectParameter("number", typeof(int));
    
            var numberSecondParameter = numberSecond.HasValue ?
                new ObjectParameter("numberSecond", numberSecond) :
                new ObjectParameter("numberSecond", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_SumTwoNumbers", numberParameter, numberSecondParameter, sum);
        }
    
        public virtual int sp_TotalCategory(ObjectParameter quantity)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_TotalCategory", quantity);
        }
    
        public virtual ObjectResult<string> SP_UpdateCategory(Nullable<int> id, string newCategoryName, string newCategoryExplanation, byte[] newImage)
        {
            ...
            var newCategoryExplanationParameter = newCategoryExplanation != null ?
                new ObjectParameter("newCategoryExplanation", newCategoryExplanation) :
                new ObjectParameter("newCategoryExplanation", typeof(string));
    
            var newImageParameter = newImage != null ?
                new ObjectParameter("newImage", newImage) :
                new ObjectParameter("newImage", typeof(byte[]));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SP_UpdateCategory", idParameter, newCategoryNameParameter, newCategoryExplanationParameter, newImageParameter);
        }
